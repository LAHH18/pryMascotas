...
<div class="container mt-4">
    <div class="alert alert-info" role="alert">
        <h4 class="alert-heading">CRUD SLIDER</h4>
    </div>
    <table id="example" class="table table-striped table-hover" style="width:100%">
        ...
        <tbody>
            ...
            $cpropiedad = new sliderController();
            $Consulta = $cpropiedad->ConsultaImgSlider();

            foreach($Consulta as $dato){
                echo '<tr>';
                echo '<td>'. $dato["slider_id"] .'</td>';
                echo '<td><img src="'. $dato["slider_url"] .'" alt=""></td>';
                echo '<td>'. $dato["slider_alt"] .'</td>';
